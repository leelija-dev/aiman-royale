...
<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        <a class="navbar-brand m-0" href="<?php echo e(route('Admin.dashboard')); ?>">
            ...
            <img src="<?php echo e(asset('web/images/amarmaa-text.webp')); ?>" alt="logo" class="pe-md-4">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav" id="menu-accordion">
            ...
            <li class="nav-item ">
                <a class="nav-link <?php echo e(request()->routeIs('admin.new-bill') ? 'active' : ''); ?>" href="<?php echo e(route('admin.new-bill')); ?>">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item ">
                <a class="nav-link <?php echo e(request()->routeIs('admin.print-bill') ? 'active' : ''); ?>" href="<?php echo e(route('admin.print-bill')); ?>">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fa-solid fa-bag-shopping" aria-hidden="true"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(request()->routeIs('stocks.*') ? 'active' : ''); ?>" href="<?php echo e(route('stocks.index')); ?>">
            ...
            <li class="nav-item has-submenu">
                ...
                <div id="marketing-menu"
                    ...
                    <ul class="submenu-list list-unstyled">
                        ...
                        <li class="submenu-item">
                            <a class="submenu-link <?php echo e(request()->routeIs('admin.product-variants.*') ? 'active' : ''); ?> "
...
</aside><?php /**PATH C:\xampp\htdocs\aiman\resources\views/components/admin/sidebar.blade.php ENDPATH**/ ?>