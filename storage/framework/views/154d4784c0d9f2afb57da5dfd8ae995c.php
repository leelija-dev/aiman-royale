<?php $__env->startSection('source', 'Generate Bill'); ?>
<?php $__env->startSection('page-title', 'Bill'); ?>
<?php $__env->startSection('title'); ?>
<?php echo e(config('app.name')); ?> - Generate Bill
...
<script>
    ...
    let products = JSON.parse('<?php echo addslashes(json_encode($products)); ?>');
    // Customers data from database
    const customers = JSON.parse('<?php echo addslashes(json_encode($customers)); ?>');
    ...
    function saveBill() {
        ...
        console.log(payload);
        fetch('<?php echo e(route("admin.bill.save")); ?>', {
                method: 'POST',
                headers: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\project\aiman-royale\resources\views/Admin/bill/index.blade.php ENDPATH**/ ?>