        ...
        <div class="container mx-auto flex justify-center items-center">
            ...
            <div class=" max-w-xl  ">
                <div class="bg-white rounded-2xl shadow-xl p-8">
                    ...
                    <form action="<?php echo e(route('web.register.add')); ?>" method="post" class="space-y-5">
                        <?php echo csrf_field(); ?>
...
<script src="<?php echo e(asset('web/js/register.js')); ?>"></script>


<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.web.main-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\aiman\resources\views/web/register.blade.php ENDPATH**/ ?>