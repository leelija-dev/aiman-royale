  ...
  <div class="container mx-auto px-4 lg:px-8 pt-6">
    ...
    <div class="border-b border-[#E8C8C8]/50 pb-12 lg:pb-16">
      <div class="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
        ...
        <div class="flex-1 w-full max-w-2xl">
          <div class="text-center lg:text-left">
            <div class="inline-flex items-center gap-2 mb-3 lg:mb-4">
              <div class="w-6 h-6 rounded-full bg-gradient-to-r from-[#8B1E2D] to-[#D26A6A]"></div>
              <span class="text-sm font-semibold text-[#8B1E2D] tracking-wider uppercase">Stay Updated</span>
            </div>
            <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 lg:mb-6 leading-tight">
              Subscribe to Our
              <span class="text-[#8B1E2D]">Newsletter</span>
            </h2>
          ...
          <form action="" class="relative">
            <div class="flex flex-col sm:flex-row gap-4">
              <div class="flex-1 relative group">
                <input
                  type="email"
                  class="w-full px-6 py-4 lg:py-5 bg-white/80 backdrop-blur-sm border-2 border-[#E8C8C8] rounded-2xl lg:rounded-3xl outline-none text-gray-800 placeholder-gray-500 transition-all duration-300 focus:border-[#D26A6A] focus:bg-white focus:shadow-lg focus:shadow-[#E8C8C8]/30"
                  placeholder="Your email address" />
                <div class="absolute inset-0 rounded-2xl lg:rounded-3xl bg-gradient-to-r from-[#8B1E2D]/0 via-[#D26A6A]/0 to-[#D29A1E]/0 group-focus-within:from-[#8B1E2D]/5 group-focus-within:via-[#D26A6A]/5 group-focus-within:to-[#D29A1E]/5 transition-all duration-500 -z-10"></div>
              </div>
              <button
                type="submit"
                class="px-8 py-4 lg:py-5 bg-gradient-to-r from-[#8B1E2D] via-[#D26A6A] to-[#D29A1E] text-white font-semibold rounded-2xl lg:rounded-3xl hover:shadow-xl hover:shadow-[#D26A6A]/30 hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 whitespace-nowrap">
                Subscribe Now
        ...
        <div class="hidden lg:block w-[1px] h-40 bg-gradient-to-b from-transparent via-[#E8C8C8] to-transparent self-stretch"></div>
        <div class="lg:hidden w-full h-[1px] bg-gradient-to-r from-transparent via-[#E8C8C8] to-transparent"></div>
        ...
        <div class="flex-1 w-full">
          <div class="text-center lg:text-left">
            <div class="inline-flex items-center gap-3 mb-4 lg:mb-6">
              ...
              <span class="text-lg font-bold text-gray-900">@AimanFashion</span>
            </div>
          ...
          <div class="grid grid-cols-4 gap-3 lg:gap-4 max-w-md mx-auto lg:mx-0">
            <div class="relative group overflow-hidden rounded-xl lg:rounded-2xl aspect-square cursor-pointer">
              <img
    ...
    <div class="py-12 lg:py-16">
      ...
      <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-12 lg:mb-16">
        ...
        <div class="flex gap-4">
          <a href="#" class="w-12 h-12 rounded-full bg-white/80 backdrop-blur-sm border border-[#E8C8C8] flex items-center justify-center hover:bg-[#1877F2] hover:text-white hover:border-[#1877F2] transition-all duration-300 group">
            <svg class="w-5 h-5 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
              <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
            </svg>
          </a>
          <a href="#" class="w-12 h-12 rounded-full bg-white/80 backdrop-blur-sm border border-[#E8C8C8] flex items-center justify-center hover:bg-[#1DA1F2] hover:text-white hover:border-[#1DA1F2] transition-all duration-300 group">
            <svg class="w-5 h-5 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
              <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.213c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z" />
            </svg>
          </a>
          <a href="#" class="w-12 h-12 rounded-full bg-white/80 backdrop-blur-sm border border-[#E8C8C8] flex items-center justify-center hover:bg-gradient-to-r hover:from-[#833AB4] hover:via-[#E1306C] hover:to-[#F77737] hover:text-white hover:border-transparent transition-all duration-300 group">
            <svg class="w-5 h-5 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
              <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z" />
            </svg>
          </a>
          <a href="#" class="w-12 h-12 rounded-full bg-white/80 backdrop-blur-sm border border-[#E8C8C8] flex items-center justify-center hover:bg-[#0077B5] hover:text-white hover:border-[#0077B5] transition-all duration-300 group">
            <svg class="w-5 h-5 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12">
        ...
        <div class="lg:col-span-1">
          <div class="accordion-header lg:cursor-default group" data-target="quick-links">
            <div class="flex items-center justify-between lg:justify-start">
              <h3 class="text-xl font-bold text-gray-900 flex items-center gap-3">
                <div class="w-2 h-8 bg-gradient-to-b from-[#8B1E2D] to-[#D26A6A] rounded-full"></div>
                Quick Links
              </h3>
          ...
          <div id="quick-links" class="accordion-content mt-6 lg:mt-8 space-y-4">
            <a href="#" class="flex items-center group/link text-gray-600 hover:text-[#8B1E2D] transition-colors duration-300">
              <div class="w-1 h-1 rounded-full bg-[#D26A6A] mr-3 group-hover/link:w-2 group-hover/link:h-2 transition-all duration-300"></div>
        ...
        <div class="lg:col-span-1">
          <div class="accordion-header lg:cursor-default group" data-target="vastram">
            <div class="flex items-center justify-between lg:justify-start">
              <h3 class="text-xl font-bold text-gray-900 flex items-center gap-3">
                <div class="w-2 h-8 bg-gradient-to-b from-[#D26A6A] to-[#D29A1E] rounded-full"></div>
                Vastram
              </h3>
              <svg class="lg:hidden w-5 h-5 text-gray-600 group-[.active]:rotate-180 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
          ...
          <div id="vastram" class="accordion-content mt-6 lg:mt-8 space-y-4">
            <a href="#" class="flex items-center group/link text-gray-600 hover:text-[#D26A6A] transition-colors duration-300">
              <div class="w-1 h-1 rounded-full bg-[#D29A1E] mr-3 group-hover/link:w-2 group-hover/link:h-2 transition-all duration-300"></div>
        ...
        <div class="lg:col-span-1">
          <div class="accordion-header lg:cursor-default group" data-target="policies">
            <div class="flex items-center justify-between lg:justify-start">
              <h3 class="text-xl font-bold text-gray-900 flex items-center gap-3">
                <div class="w-2 h-8 bg-gradient-to-b from-[#D29A1E] to-[#E8C8C8] rounded-full"></div>
                Policies
              </h3>
              <svg class="lg:hidden w-5 h-5 text-gray-600 group-[.active]:rotate-180 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
          ...
          <div id="policies" class="accordion-content mt-6 lg:mt-8 space-y-4">
            <a href="#" class="flex items-center group/link text-gray-600 hover:text-[#D29A1E] transition-colors duration-300">
              <div class="w-1 h-1 rounded-full bg-[#E8C8C8] mr-3 group-hover/link:w-2 group-hover/link:h-2 transition-all duration-300"></div>
        ...
        <div class="lg:col-span-1">
          <div class="accordion-header lg:cursor-default group" data-target="account">
            <div class="flex items-center justify-between lg:justify-start">
              <h3 class="text-xl font-bold text-gray-900 flex items-center gap-3">
                <div class="w-2 h-8 bg-gradient-to-b from-[#E8C8C8] to-[#8B1E2D] rounded-full"></div>
                My Account
              </h3>
              <svg class="lg:hidden w-5 h-5 text-gray-600 group-[.active]:rotate-180 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
          ...
          <div id="account" class="accordion-content mt-6 lg:mt-8 space-y-4">
            <a href="#" class="flex items-center group/link text-gray-600 hover:text-[#8B1E2D] transition-colors duration-300">
              <div class="w-1 h-1 rounded-full bg-[#8B1E2D] mr-3 group-hover/link:w-2 group-hover/link:h-2 transition-all duration-300"></div>
        ...
        <div class="lg:col-span-1">
          <div class="lg:cursor-default">
            <h3 class="text-xl font-bold text-gray-900 flex items-center gap-3 mb-8">
              <div class="w-2 h-8 bg-gradient-to-b from-[#8B1E2D] via-[#D26A6A] to-[#D29A1E] rounded-full"></div>
              Contact Info
            </h3>
          </div>
          <div class="space-y-6">
            <div class="flex items-start gap-4">
              <div class="w-10 h-10 rounded-full bg-gradient-to-r from-[#8B1E2D]/10 to-[#D26A6A]/10 flex items-center justify-center flex-shrink-0">
                <svg class="w-5 h-5 text-[#8B1E2D]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <!-- Bottom Bar -->
    <div class="border-t border-[#E8C8C8]/50 pt-8 pb-12">
