                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="code_for"
                                        name="code_for" value="{{ old('code_for') }}" >
                                    @error('code_for')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="validity" name="validity" value="{{ old('validity') }}">
                                 ...
                                 <div class="mb-3">
                                    ...
                                    <select class="form-control" id="code_type" name="code_type" required>
                                        ...
                                        <option value="influencer-discount" {{ old('code_type') == 'influencer-discount' ? 'selected' : '' }}>
                                            Influencer Discount
                                        </option>
                                        <option value="special-discount" {{ old('code_type') == 'special-discount' ? 'selected' : '' }}>
                                            Special Discount 
                                        </option>
                                    </select>
