        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card px-5 pt-2 pb-3">
                    <form action="{{ route('store.store') }}" method="POST" enctype="multipart/form-data" novalidate>
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <!-- Name -->
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="gst_percentage"
                                        name="gst_percentage" value="{{ old('gst_percentage') }}" >
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="is_active" name="is_active" required>
                                        <option value="1"
                                            {{ old('is_active', $hero->status ?? '1') == '1' ? 'selected' : '' }}>
                                            Active
                                        </option>
                                        <option value="0"
                                            {{ old('is_active', $hero->status ?? '1') == '0' ? 'selected' : '' }}>
                                            Inactive
                                        </option>
                                    </select>
                                    @error('is_active')
