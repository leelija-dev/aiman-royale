                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 mb-3">
                                    ...
                                    <input type="number"  id="weight" name="weight" placeholder="Weight.." class="form-control">
                                    @error('weight')
                                        <div class="text-danger small">{{ $message }}
                                        </div>
                                    @enderror
                                ...
                                <div class="row">
                                    ...
                                    <input type="number"  id="height" name="height" placeholder="Height.." class="form-control" required>
                                    @error('height')
                                        <div class="text-danger small">{{ $message }}
                                        </div>
                                    @enderror
