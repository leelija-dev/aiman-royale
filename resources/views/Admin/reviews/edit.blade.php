                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" name="is_verified" id="is_verified" class="custom-control-input" {{ old('is_verified', $review->is_verified) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" name="is_featured" id="is_featured" class="custom-control-input" {{ old('is_featured', $review->is_featured) ? 'checked' : '' }}>
