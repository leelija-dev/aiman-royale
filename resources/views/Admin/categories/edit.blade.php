      ...
      <form id="updateCategory" action="{{ route('admin.categories.update', $category->id) }}" method="post" enctype="multipart/form-data" novalidate>
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="mb-3">
              <label class="form-label text-secondary text-uppercase">Title<sup class="text-danger">*</sup></label>
              <input type="text" name="title" class="form-control" value="{{ old('name', $category->title) }}" required>
              <div class="invalid-feedback">Product category title cannot be blank!</div>
              @error('title')
              <div class="invalid-feedback d-block">{{ $message }}</div>
              @enderror
            </div>
            <div class="mb-3">
              ...
              <textarea name="about" class="form-control" rows="5" required>{{ old('about', $category->about) }}</textarea>

              <div class="invalid-feedback">
                About field cannot be blank!
              </div>
            ...
            <div class="mb-3">
              ...
              <textarea name="description"  id="description-editor" rows="4" class="form-control">{{  $category->description }}</textarea>
              @error('description')
              <div class="invalid-feedback d-block">{{ $message }}</div>
              @enderror
            </div>
