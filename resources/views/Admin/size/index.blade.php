        ...
        <div class="card mb-4">
            <div class="card-header pb-0 d-flex flex-wrap flex-lg-nowrap justify-content-between align-items-center">
                ...
                <div class="d-flex gap-2 flex-sm-nowrap flex-wrap justify-content-end w-100 w-xl-50">
                    <a href="{{ route('admin.sizes.create') }}" class="btn btn-primary w-100 w-sm-auto mb-sm-3 mb-1">
                ...
                <div class="table-responsive p-0">
                    <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle text-center">
                                    <a href="#" class="text-secondary font-weight-bold text-xs me-4"
                                       data-bs-toggle="modal" data-bs-target="#editModal{{ $size->id }}"
                                       title="Edit size">
                                        <i class="fa-solid fa-pen-to-square"></i>
                                    </a>
                                    <form id="delete-form-{{ $size->id }}"
                                          action="{{ route('admin.sizes.delete', $size->id) }}"
                            ...
                            <!-- Edit Modal -->
                            <div class="modal fade" id="editModal{{ $size->id }}" tabindex="-1" aria-labelledby="editModalLabel{{ $size->id }}" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="editModalLabel{{ $size->id }}">Edit Size</h5>
