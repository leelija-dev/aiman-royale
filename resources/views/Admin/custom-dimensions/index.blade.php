                                            ...
                                            <div class="d-flex px-2 py-1">
                                                <div class="d-flex align-items-center">
                                                    @if($request->product && $request->product->images->isNotEmpty())
                                                        <img src="{{ asset('storage/' . $request->product->images->first()->image) }}" alt="{{ $request->product->name }}" class="me-2" style="width: 40px; height: 40px; object-fit: cover; border-radius: 8px;">
                                                    @else
