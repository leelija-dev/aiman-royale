                ...
                <div id="categories-carousel" class="owl-carousel owl-theme">
                    ...
                    @else
                        ...
                        @foreach ($categories as $category)
                            <div class="item p-2">
                                <a href="{{ route('category.show', $category->slug) }}"
                                    class="group block relative overflow-hidden rounded-[0px]">
    ...
    <section class="px-4 lgg:py-8 py-6">
        <div class="container mx-auto">
            <div id="ads-carousel" class="owl-carousel owl-theme">
                ...
                <x-web.home.banners.offers.sale :saleType="'Winter'" :discount="60" :image="'web/images/product-images/gray-lahenga-3_40_11zon.webp'" />

                <!-- Banner 2: Summer Skincare Tips -->
                <x-web.home.banners.offers.tips :saleType="'Fall'" :tipsType="'Skincare'" :image="'web/images/product-images/light-pink-plazo-5_57_11zon.webp'" />

                <!-- Banner 3: Summer Dress Sale -->
                <x-web.home.banners.offers.last-chance :saleType="'Valentine'" :discount="25" :saleRange="'Storewide'"
                    :cuponCode="'C-1623B5OFO'" :image="'web/images/product-images/pink-plazo-1_76_11zon.webp'" />

                <!-- Banner 4: Latest Fashion -->
                <x-web.home.banners.offers.new-arrival :eventType="'New Arrival'" :eventFocus="'Latest Fashion Vibe'" :image="'web/images/product-images/red-plazo-9_95_11zon.webp'" />
            </div>
        </div>
    </section>
            ...
            <div class="flex flex-col lgg:flex-row gap-8 lgg:gap-12">
                ...
                <div class="w-full lgg:w-[59%] flex justify-center items-center">
                    <div class="second-owl owl-carousel owl-theme relative">
                        ...
                        @for ($i = 1; $i <= 5; $i++)
                            <x-web.home.banners.discounts.sale :sequence="$i" :saleType="'Winter'" :discount="20" :image="asset('web/images/product-images/dark-red-plazo-2_12_11zon.webp')" />
                        @endfor
                        ...
                        <div
                            ...
                            <div class="relative rounded-[6px] overflow-hidden">
                                ...
                                <a href="{{ route('category.show', $product->category->slug) }}">
                                    <img src="{{ asset($product->images->first()->image) }}" alt="Silver Lehenga"
                                        class="w-full h-auto aspect-[9/13] object-cover object-top object-center" />
                                </a>
