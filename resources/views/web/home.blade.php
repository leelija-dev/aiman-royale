                ...
                <div class="">
                    ...
                    <div class="lgg:text-left text-center">
                        ...
                        <p class="text-gray-600 text-base md:text-lg leading-relaxed mb-8 max-w-lg lgg:mx-0 mx-auto">
                            Shop the latest 150+ designer outfits with confidence. If you see it cheaper elsewhere in 30
                            days, we’ll beat that price.
                        </p>
                    ...
                    <div class="flex lg:flex-row flex-col  gap-12 lg:gap-16">
                        ...
                        <div
                            ...
                            <p class="text-gray-600 text-center mb-8 leading-relaxed">
                                Find your perfect look with our virtual try-ons & connect with our stylists live for
                                tailored one-on-one styling advice.
                            </p>
                        ...
                        <div
                            ...
                            <!-- Service Description -->
                            <p class="text-gray-600 text-center mb-8 leading-relaxed">
                                Your go-to bridal stylist, guiding you step-by-step to help you find the perfect wedding
