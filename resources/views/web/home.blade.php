        ...
        <div class="relative overflow-x-auto scrollbar-hide snap-x snap-mandatory px-0">
            ...
            400px"
                ...
                {{-- @php
                                        ...
                                        if ($catImage) {
                                            $isCloudinary =
                                                str_contains($catImage, 'cloudinary.com') &&
                                                str_contains($catImage, 'upload/');
                                            ...
                                            if ($isCloudinary) {
                                                ...
                                                $cld = fn($w, $h) => $parts[0] .
                                                    "upload/w_{$w},h_{$h},c_fill,f_auto,q_auto,dpr_auto/" .
                                                    $parts[1];
                    ...
                    @else
                        ...
                        @foreach ($categoriesWithProduct as $category)
                            <div class="item p-2">
                                ...
                                @php
                                    $catImg = $category->latestProductWithImage->featured_image
                                        ? url(
                                            '/img/' . $category->latestProductWithImage->featured_image . '?w=600&q=80',
                                        )
                                        : $category->image;

                                    if (
                                        strpos($catImg, 'cloudinary.com') !== false &&
                                        strpos($catImg, 'upload/') !== false
                                    ) {
                            ...
                            {{ $catImg }}?w=800&q=80 800w"
                                        ...
                                        width="450" height="650" loading="lazy" decoding="async"
                                    ...
                                    <div class="absolute bottom-8 left-12 right-6">

                                        <h3 class="heading-font text-3xl text-white leading-tight truncate">
                ...
                <div id="categories-tag-carousel" class="owl-carousel owl-theme">
                    ...
                    @foreach ($categoriesWithProduct as $category)
                        @php
                            ...
                            if (
                                strpos($tagImage, 'cloudinary.com') !== false &&
                                strpos($tagImage, 'upload/') !== false
                            ) {
                        ...
                        <div class="item ">
                            ...
                            <a href="{{ route('category.show', $category->slug) }}" class="group block">
                                ...
                                <div class="overflow-hidden bg-[#fafafa]">
                                    ...
                                    <div class="aspect-[3/4] overflow-hidden rounded-[10px]">
                                        ...
                                        <img src="{{ $tagImage }}"
                                            ...
                                            alt="{{ $category->name }}" loading="lazy" decoding="async" width="400"
                                            height="520"
                                ...
                                <div class="pt-5 text-center">
                                    ...
                                    <h3 class="heading-font text-lg lg:text-xl text-gray-900 font-medium truncate">
                                    ...
                                    <span
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="w-3 h-3 transition group-hover:translate-x-1" fill="none"
...
$isCloudinary =
    str_contains($imagePath, 'cloudinary.com') ||
...
if ($isCloudinary) {
    ...
    if (
        ...
        str_contains($imagePath, 'cloudinary.com') &&
        str_contains($imagePath, 'upload/')
    ) {
        $parts = explode('upload/', $imagePath);
        $imageUrl =
            $parts[0] .
            'upload/w_600,h_900,c_fill,f_auto,q_auto,dpr_auto/' .
            ($parts[1] ?? '');
    } elseif (str_contains($imagePath, 'aiman/')) {
        $imageUrl =
            'https://res.cloudinary.com/dwbseti83/image/upload/w_600,h_900,c_fill,f_auto,q_auto/' .
            $imagePath;
    } else {
        $imageUrl =
            'https://res.cloudinary.com/dwbseti83/image/upload/w_600,h_900,c_fill,f_auto,q_auto/' .
            ...
            <div class="grid lgg:grid-cols-3 lgg:gap-4 gap-8 xl:gap-16 items-center">
                ...
                <div class="">
                    <div class="lgg:text-left text-center">
                        <div class="mb-6">
                            <h3 class="text-2xl md:text-5xl font-bold text-gray-900 heading-font">Shop With Complete
                                Confidence</h3>
                        </div>
                        <p class="text-gray-600 text-base md:text-lg leading-relaxed mb-8 max-w-lg lgg:mx-0 mx-auto">
                            From designer craftsmanship to our affordable luxury, every purchase is backed by our commitment
                            to you.
                        </p>
                    </div>
                ...
                <div class="relative">
                    <div class="relative w-full max-w-md mx-auto">
                        ...
                        <div
                            ...
                            <img src="{{ asset('web/images/product-images/light-red-plazo-4_73_11zon-3.webp') }}?w=400&q=80"
                                srcset="{{ asset('web/images/product-images/light-red-plazo-4_73_11zon-3.webp') }}?w=300&q=80 300w,
                                    {{ asset('web/images/product-images/light-red-plazo-4_73_11zon-3.webp') }}?w=400&q=80 400w,
                                    {{ asset('web/images/product-images/light-red-plazo-4_73_11zon-3.webp') }}?w=600&q=80 600w"
                                sizes="(max-width: 640px) 150px, (max-width: 1024px) 200px, 300px" alt="Saree Collection"
                        ...
                        <div
                            ...
                            <img src="{{ asset('web/images/product-images/gray-lahenga-3_40_11zon-2.webp') }}?w=600&q=80"
                                srcset="{{ asset('web/images/product-images/gray-lahenga-3_40_11zon-2.webp') }}?w=400&q=80 400w,
                                    {{ asset('web/images/product-images/gray-lahenga-3_40_11zon-2.webp') }}?w=600&q=80 600w,
                                    {{ asset('web/images/product-images/gray-lahenga-3_40_11zon-2.webp') }}?w=800&q=80 800w"
                                sizes="(max-width: 640px) 225px, (max-width: 1024px) 300px, 400px" alt="Premium Lehenga"
                        ...
                        <div
                            ...
                            <img src="{{ asset('web/images/product-images/light-pink-m-4_51_11zon-1.webp') }}?w=400&q=80"
                                srcset="{{ asset('web/images/product-images/light-pink-m-4_51_11zon-1.webp') }}?w=300&q=80 300w,
                                    {{ asset('web/images/product-images/light-pink-m-4_51_11zon-1.webp') }}?w=400&q=80 400w,
                                    {{ asset('web/images/product-images/light-pink-m-4_51_11zon-1.webp') }}?w=600&q=80 600w"
                                sizes="(max-width: 640px) 150px, (max-width: 1024px) 200px, 300px" alt="Party Wear"
                                class="w-full h-full object-cover object-top rounded-xl shadow-lg border-3 border-white group-hover:border-secondary-light transition-all duration-300"
                                loading="lazy" decoding="async" width="400" height="400"
                                style="aspect-ratio: 400/400;">
                            <div
                        ...
                        <div
                            ...
                            <img src="{{ asset('web/images/product-images/glow-orange-3_18_11zon-4.webp') }}?w=300&q=80"
                                srcset="{{ asset('web/images/product-images/glow-orange-3_18_11zon-4.webp') }}?w=200&q=80 200w,
                                    {{ asset('web/images/product-images/glow-orange-3_18_11zon-4.webp') }}?w=300&q=80 300w,
                                    {{ asset('web/images/product-images/glow-orange-3_18_11zon-4.webp') }}?w=400&q=80 400w"
                                sizes="(max-width: 640px) 125px, (max-width: 1024px) 150px, 200px" alt="Kurta Set"
                                class="w-full h-full object-cover object-top group-hover:scale-110 transition-transform duration-500"
                            ...
                            <div class="flex -space-x-3">
                                <div class="w-8 h-8 rounded-full border-2 border-white overflow-hidden shadow-sm">
                                    <img src="https://images.unsplash.com/photo-1595777457583-95e059d581b8?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80"
                                        ...
                                        sizes="32px" alt="" class="w-full h-full object-cover" loading="lazy"
    ...
    <section class="px-4 lgg:py-12 py-8 bg-[#fdfaf7]">
        <div class="container mx-auto">
            ...
            <div class="lgg:text-left text-center mb-5">
                <h2
                    class="font-thin font-[initial] text-2xl sm:text-3xl md:text-4xl lg:text-[49px] leading-tight text-[#2c1810] mb-2">
                    The Wedding Edit</h2>
...
if ($isCloudinary) {
    ...
    if (
        ...
        if (str_contains($imagePath, 'upload/')) {
            ...
            $bannerImg =
                $parts[0] . 'upload/w_600,h_1000,c_fill,f_auto,q_auto/' . $cloudinaryPath;
        } else {
            $bannerImg = $imagePath;
        }
    } elseif (str_contains($imagePath, 'aiman/banners/')) {
        $bannerImg =
            'https://res.cloudinary.com/dwbseti83/image/upload/w_600,h_1000,c_fill,f_auto,q_auto/' .
            $imagePath;
    } else {
        $bannerImg =
            'https://res.cloudinary.com/dwbseti83/image/upload/w_600,h_1000,c_fill,f_auto,q_auto/' .
...
if ($banner->filter) {
                        ...
                        data-filter="{{ $banner->filter ?? ($banner->discount ?? '') }}" @endif>
                                ...
                                <div class="absolute inset-0">
                                    <img class="w-full h-full object-cover object-center transition-transform duration-700 ease-out group-hover:scale-105"
                                        ...
                                        alt="{{ $banner->title }}" loading="lazy" decoding="async" width="600"
                                        height="1000" style="aspect-ratio: 600/1000;" />
                                </div>

                                <!-- Subtle Gradient Overlay -->
                                <div
                                    class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent opacity-40 transition-opacity duration-500">
                                </div>

                                <!-- Content - Clean Layout -->
                                <div class="absolute bottom-[5px] left-0 right-0 py-5 md:py-6 px-[14px]">
                                    <div
                                        class="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500 ease-out flex flex-col items-center justify-center">
                                        <!-- Category -->
                                        @if ($banner->subtitle)
                                            <span
                                                class="inline-block text-white/80 text-[9px] md:text-[10px] font-medium tracking-[0.2em] uppercase mb-1.5">
                                                {{ $banner->subtitle }}
                                            </span>
                                        @endif
                                        ...
                                        <!-- Title -->
                                        <h3
                                            class="text-white text-lg md:text-xl lg:text-2xl font-light tracking-wide leading-tight mb-1">
                                            {{ $banner->title }}
                                        </h3>
                                        ...
                                        <!-- Shop Now Button -->
                                        <span
                                            class="inline-block rounded-[11px] bg-gradient-to-r from-primary to-secondary hover:from-secondary hover:to-primary text-white px-5 md:px-6 py-1.5 md:py-2 text-[10px] md:text-xs font-medium tracking-wide transition-all duration-300 ease-in-out cursor-pointer">
                                            Shop Now
                                        </span>
                                    </div>
                                </div>
    ...
    active:translate-y-0 active:scale-95">
                    ...
                    @endif --}}
                            @if ($days > 0)
                                <h4
                                    class="text-xl sm:text-2xl md:text-3xl lg:text-[31px] font-medium text-gray-800 leading-tight">
                                    Hurry…only
                            ...
                            @elseif($minutes > 0)
                                <h4
                                    class="text-xl sm:text-2xl md:text-3xl lg:text-[31px] font-medium text-gray-800 leading-tight">
                                    Hurry…only
                                    <span id="minutesLabel"
                                        class="font-semibold text-gray-900">{{ $minutes }}</span>
                            ...
                            <div class="mt-7 flex flex-wrap justify-center lgg:justify-start gap-6">

                                <div class="text-center">

                                    <div id="daysBox" class="heading-font text-4xl font-medium text-gray-900">
                                        35
                                    </div>
                                ...
                                <div class="text-center">
                                    ...
                                    <div id="hoursBox" class="heading-font text-4xl font-medium text-gray-900">
                                        11
                                    </div>
                                ...
                                <div class="text-center">
                                    ...
                                    <div id="minutesBox" class="heading-font text-4xl font-medium text-gray-900">
                                        25
                                    </div>
                                ...
                                <div class="text-center">
                                    ...
                                    <div id="secondsBox" class="heading-font text-4xl font-medium text-gray-900">
                                        08
                                    </div>
                ...
                <div class="w-full lgg:w-[59%] flex justify-center items-center">
                    <div class="second-owl owl-carousel owl-theme relative w-full">
                        @foreach ($secondaryBanners as $banner)
                            @php
                                $isCloudinary =
                                    str_contains($banner->image, 'cloudinary.com') ||
                                ...
                                if ($banner->filter) {
                                    if ($banner->filter_type === 'multiple' && $banner->filters) {
                                        ...
                                        $bannerFilterUrl =
                                            '/products?' . ($banner->filter ?? ($banner->discount ?? ''));
                                    }
                                }
                            @endphp
                            ...
                            data-filter="{{ $banner->filter ?? ($banner->discount ?? '') }}" @endif>
                                    ...
                                    <div
                                        class="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/70 via-black/30 to-[#00000005]">
                                        <div class="px-4 py-4 sm:px-5 sm:py-5 text-center text-white">
                                            ...
                                            <div class="flex items-center justify-center gap-2 mb-1">
                                                ...
                                                <span
                                                    class="text-[10px] sm:text-[11px] uppercase tracking-[0.25em] text-white font-[700]">
                                                    {{ $banner->subtitle }}
                                                </span>
                                            ...
                                            <!-- CTA -->
                                            <div
                                                class="mt-4 opacity-0 translate-y-3 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500 ease-out">
                                                <a href="{{ $bannerFilterUrl }}"
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                        ...
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="2" d="M5 12h14m-5-5 5 5-5 5" />
                                                    </svg>
                                                </a>
                                            </div>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 divide-x divide-gray-200">
                ...
                <div class="px-6 py-4 text-center">
                    <img src="{{ asset('web/images/icons/icon1.svg') }}" alt="Premium Quality"
                        class="w-11 h-11 mx-auto opacity-80 transition duration-300 hover:opacity-100" loading="lazy"
                ...
                <!-- Item -->
                <div class="px-6 py-4 text-center">
                    <img src="{{ asset('web/images/icons/icon2.svg') }}" alt="Buyer Protection"
                        class="w-11 h-11 mx-auto opacity-80 transition duration-300 hover:opacity-100" loading="lazy"
                        decoding="async" width="44" height="44">
                ...
                <!-- Item -->
                <div class="px-6 py-4 text-center">
                    <img src="{{ asset('web/images/icons/icon4.svg') }}" alt="Free Shipping"
                        class="w-11 h-11 mx-auto opacity-80 transition duration-300 hover:opacity-100" loading="lazy"
                        decoding="async" width="44" height="44">
                ...
                <!-- Item -->
                <div class="px-6 py-4 text-center">
                    <img src="{{ asset('web/images/icons/icon3.svg') }}" alt="24/7 Support"
                        class="w-11 h-11 mx-auto opacity-80 transition duration-300 hover:opacity-100" loading="lazy"
                        decoding="async" width="44" height="44">
                ...
                @forelse($mostWishlisted as $index => $product)
                    @php
                        ...
                        $imageUrl = $product->featured_image
                            ? url('/img/' . $product->featured_image . '?w=600&q=80')
                                    ...
                                    @else
                                        <span
                                            ...
                                            @php
                                                ...
                                                $value =
                                                    $discount - floor($discount) >= 0.5 ? ceil($discount) : $discount;
                                            @endphp
    ...
    <section class="py-16 lg:py-20 px-4 bg-gradient-to-b from-white to-gray-50">
        <div class="container mx-auto">
            <div class="text-center mb-12 lg:mb-16">
                <h2
                    class="text-3xl lg:text-4xl lg:leading-[3rem] leading-[2.5rem] font-bold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent mb-4 heading-font">
                    ...
                    <div class="flex lg:flex-row flex-col gap-8 lg:gap-12">
                        <div
                            ...
                            <p class="text-gray-600 text-center mb-8 leading-relaxed">
                                A free service that has been provided so that you can who are trusting with your style and
                                money. What happens during your time with us
                            </p>
                ...
                <div
                    ...
                    <div id="designer-thoughts" class="owl-carousel owl-theme mt-8">
                        ...
                        <div class="slide-item">
                            ...
                            <h3 class="text-2xl font-bold text-gray-900 mb-6 text-center font-serif">The Palazzo Revolution
                            </h3>
                            <div class="relative">
                                <div class="absolute -left-4 top-1/2 transform -translate-y-1/2 text-secondary">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="currentColor"
