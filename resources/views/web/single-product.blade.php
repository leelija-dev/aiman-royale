                ...
                <div class="space-y-2">
                    ...
                    <div class="flex items-center gap-2 text-xs">
                        ...
                        <div class="flex-1 h-1.5 bg-gray-200 rounded-full">
                            <div class="bg-yellow-400 h-full rounded-full" style="width: {{ $fivePercent }}%"></div>
                        </div>
                    ...
                    <div class="flex items-center gap-2 text-xs">
                        ...
                        <div class="flex-1 h-1.5 bg-gray-200 rounded-full">
                            <div class="bg-yellow-400 h-full rounded-full" style="width: {{ $fourPercent }}%"></div>
                        </div>
                    ...
                    <div class="flex items-center gap-2 text-xs">
                        ...
                        <div class="flex-1 h-1.5 bg-gray-200 rounded-full">
                            <div class="bg-yellow-400 h-full rounded-full" style="width: {{ $threePercent }}%"></div>
                        </div>
