...
@section('content')
    ...
    <section class="px-4 lg:pb-12 pb-6 lg:pt-6 pt-4">
        <div class="container mx-auto mb-4 flex flex-row lgg:justify-end justify-between gap-3 flex-wrap lgg:px-6 px-4">
            <!-- Mobile Filter Button -->
            <button id="open-filter" type="button"
            ...
            <div class="flex flex-row gap-3 flex-wrap">
                ...
                <!-- Collection Dropdown -->
                <div class="relative inline-block text-left">
                    <button type="button" id="collection-dropdown-button"
                        class="flex items-center gap-3 px-5 py-2.5 rounded-full border border-gray-300 bg-white text-gray-800 text-sm font-medium shadow-sm transition-all duration-200 hover:bg-gray-50 hover:border-gray-400 hover:shadow focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1 active:scale-95"
                        aria-haspopup="true" aria-expanded="false">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-gray-600" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        ...
                        <svg id="collection-chevron" xmlns="http://www.w3.org/2000/svg"
                            class="w-4 h-4 text-gray-600 ml-1 transition-transform duration-200" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                        </svg>
                    ...
                    <div id="collection-menu"
                        ...
                        role="menu" aria-orientation="vertical" aria-labelledby="collection-dropdown-button">
                        <div class="py-2" role="none">
                            <button type="button"
                                ...
                                data-value="spring-2024" role="menuitem">
                            ...
                            <button type="button"
                                class="collection-option w-full flex items-center justify-between px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none"
                                data-value="summer-essentials" role="menuitem">
                            ...
                            <button type="button"
                                class="collection-option w-full flex items-center justify-between px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none"
                                data-value="limited-edition" role="menuitem">
                            ...
                            <button type="button"
                                class="collection-option w-full flex items-center justify-between px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none"
                                data-value="winter-collection" role="menuitem">
                ...
                <div class="relative inline-block text-left">
                    <button type="button" id="sort-button"
                        ...
                        <svg id="chevron-icon" xmlns="http://www.w3.org/2000/svg"
                            class="w-4 h-4 text-gray-600 ml-1 transition-transform duration-200" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                        </svg>
                    ...
                    <div id="sort-menu"
                        ...
                        <div class="py-2" role="none">
                            <button type="button"
                                ...
                                data-value="name-asc" role="menuitem">
                            ...
                            <button type="button"
                                class="sort-option w-full flex items-center justify-between px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none"
                                data-value="name-desc" role="menuitem">
                            ...
                            <button type="button"
                                ...
                                data-value="date-desc" role="menuitem">
                            ...
                            <button type="button"
                                class="sort-option w-full flex items-center justify-between px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none"
                                data-value="date-asc" role="menuitem">
                            ...
                            <button type="button"
                                class="sort-option w-full flex items-center justify-between px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none"
                                data-value="price-asc" role="menuitem">
                            ...
                            <button type="button"
                                class="sort-option w-full flex items-center justify-between px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none"
                                data-value="price-desc" role="menuitem">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (clearFiltersBtn) {
                clearFiltersBtn.addEventListener('click', function() {
                    ...
                    '.filter-option[data-value="new-arrival"]');
                    if (defaultFilter) {
                    ...
                    const defaultCollection = document.querySelector(
                    '.collection-option[data-value="all"]');
            ...
            setupDropdownWithClose('filter-menu', 'filter-dropdown-button', 'filter-chevron', 'filter-label',
                'filter-option', 'filter');
            setupDropdownWithClose('occasion-menu', 'occasion-dropdown-button', 'occasion-chevron',
                'occasion-label', 'occasion-option', 'occasion');
            setupDropdownWithClose('collection-menu', 'collection-dropdown-button', 'collection-chevron',
                'collection-label', 'collection-option', 'collection');
